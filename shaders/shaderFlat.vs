...
smooth out vec4 FragColorSmooth;
flat out vec4 FragColorFlat;
...
void main()
{
    ...
    FragColorSmooth = vec4(result, 1.0);
    FragColorFlat = vec4(result, 1.0);
...
vec3 CalcPointLight(PointLight light, vec3 normal, vec3 fragPos, vec3 viewDir)
{
    ...
    if (material.hasTexture)
        textureVal = vec3(texture(material.textureID, aTexCoords));
    else 
        textureVal = vec3(1.0);
